...
const CONFIG = {
    ...
    textos: {
        ...
        cat2: { t: "ESTO NOS HACE DIFERENTES", c: "En nuestras sucursales servimos las mejores especialidades de la casa, platillos tradicionales, postres y bebidas refrescantes. Contando en algunas de ellas con entrega a domicilio o con pedidos directamente en el restaurante." },
...
function renderGallery(cat) {
    ...
    if (cat === 'cat3' || cat === 'cat2') {
        ...
        if (cat === 'cat3') {
            ...
            videoContainer.innerHTML = `
                <a href="https://www.youtube.com/shorts/ZRmk49JXsVc" target="_blank" style="background: #b00; color: #fff; padding: 12px 25px; border-radius: 12px; text-decoration: none; font-weight: 900; font-size: 0.9rem;">
